...
int main()
{
    ...
    case 4:
        ...
        {
            cout << "\n\tOnly" << Qnoodles - Snoodles << " Noodle remaing in hotel. ";
            break;
        }
    case 5:
    ...
    case 6:
        ...
        {
            cout << "\n\tOnly" << Qchicken - Schicken << "chicken remaing in hotel. ";
            break;
        }
    ...
    case 7:
        ...
        cout << "\n\n Total shake colection for the day : " << Total_shake;

        cout << "\n\n Number of chicken-roll we had : " << Qchicken;
        cout << "\n\n Number of chicken-roll we gave for rent " << Schicken;
        cout << "\n\n Remaing chicken-roll : " << Qchicken - Schicken;
        cout << "\n\n Total chicken-roll colection for the day : " << Total_chicken;

        cout << "\n\n Number of burger we had : " << Qburger;
        cout << "\n\n Number of burger we gave for rent " << Sburger;
        cout << "\n\n Remaing burger : " << Qburger - Sburger;
        cout << "\n\n Total burger colection for the day : " << Total_noodles;
